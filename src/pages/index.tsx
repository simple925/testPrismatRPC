...
const IndexPage: NextPageWithLayout = () => {
  ...
  const data = trpc.members.list.useQuery({limit:1})
  console.log(data)
  const postsQuery = trpc.members.list.useInfiniteQuery(
    {
      limit: 5,
    },
    {
  ...
  const addPost = trpc.members.add.useMutation({
    async onSuccess() {
      ...
      <div className="flex flex-col py-8 items-center">
        ...
        <form
          ...
          onSubmit={async (e) => {
            ...
            type Input = inferProcedureInput<AppRouter['members']['add']>;
              //  ^?
            const input: Input = {
